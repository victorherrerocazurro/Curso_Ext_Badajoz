...
function showResult(btn){
  console.info('You clicked the ' + btn + ' button');
};

function showResultText(btn, text){
  console.info('You clicked the ' + btn + ' button and entered the text: ' + text);
};
...
Ext.onReady(function(){
    ...
    var htmlElement = document.getElementById('mb9');

    var elementoExt = Ext.get(htmlElement);

    Ext.fly('mb9').update("prueba");
